...
// Aplicação para gerenciar a situação de estudantes numa escola. A sua primeira
// tarefa é criar uma função que, ao ser chamada, determina a aprovação ou não de
// uma pessoa estudante e atualiza seu status no banco de dados como Aprovada ou
// Reprovada. Além disso, as notas marcadas de 0% a 100% (0.0 a 1.0) devem ser
// convertidas para os conceitos de A a F.
