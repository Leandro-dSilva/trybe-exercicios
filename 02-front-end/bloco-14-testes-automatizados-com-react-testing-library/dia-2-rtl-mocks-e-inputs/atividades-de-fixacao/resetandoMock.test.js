...
// Aplicando jest.fn() não há como restaurar as implementações originais da função. A única ferramenta que permite transitar entre simulação e comportamento original é o jest.spyOn() .